...
pal1 = gb_question.palette()
pal1.setColor(255,255,255)
...
h4_main.addWidget(btn_next, stretch=6)
h4_main.addStretch(4)

v1_main.addLayout(h1_main, stretch=6)
v1_main.addLayout(h2_main, stretch=6)
v1_main.addLayout(h3_main, stretch=10)
v1_main.addLayout(h4_main)
v1_main.setSpacing(8)
window.setLayout(v1_main)
window.resize(1280, 720)
pal = window.palette()
pal.setColor(QtGui.QPalette.Normal, QtGui.QPalette.Window, QtGui.QColor("#255255"))
